...
class DaveAndBambiFreeplayState extends MusicBeatState
{
	...
	{	
        ...
        bg.loadGraphic('backgrounds/freeplay/davehouse');
		bg.screenCenter();
		add(bg);

		addWeek(['corned'], 2, ['bambi']);
		addWeek(['whoopsie'], 2, ['expunged']);
		addWeek(['binomial'], 2, ['dave']);
		addWeek(['get-ready'], 2, ['dave-annoyed']);
